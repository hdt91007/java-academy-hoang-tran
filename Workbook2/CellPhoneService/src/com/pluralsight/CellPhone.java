...
// properties
    ...
    //Construct parameter
    public CellPhone(int para_SerialNumber, String para_model, String para_Carrier,String para_phonNumber, String para_owner) {
        this.SerialNumber = para_SerialNumber;
        this.model = para_model;
